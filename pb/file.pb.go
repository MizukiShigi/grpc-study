...
func (x *ApploadRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApploadRequest) ProtoMessage() {}

func (x *ApploadRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_file_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApploadRequest.ProtoReflect.Descriptor instead.
func (*ApploadRequest) Descriptor() ([]byte, []int) {
	return file_proto_file_proto_rawDescGZIP(), []int{4}
}

func (x *ApploadRequest) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *ApploadResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApploadResponse) ProtoMessage() {}

func (x *ApploadResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_file_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApploadResponse.ProtoReflect.Descriptor instead.
func (*ApploadResponse) Descriptor() ([]byte, []int) {
	return file_proto_file_proto_rawDescGZIP(), []int{5}
}

func (x *ApploadResponse) GetSize() int32 {
	if x != nil {
		return x.Size
	}
	return 0
...
var file_proto_file_proto_rawDesc = []byte{
	...
	,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x38,
	0x0a, 0x07, 0x41, 0x70, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x14, 0x2e, 0x66, 0x69, 0x6c, 0x65,
	0x2e, 0x41, 0x70, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x15, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x41, 0x70, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65,
...
var file_proto_file_proto_goTypes = []interface{}{
	...
	(*ApploadRequest)(nil),    // 4: file.ApploadRequest
	(*ApploadResponse)(nil),   // 5: file.ApploadResponse
}
var file_proto_file_proto_depIdxs = []int32{
	...
	4, // 2: file.FileService.Appload:input_type -> file.ApploadRequest
	...
	5, // 5: file.FileService.Appload:output_type -> file.ApploadResponse
